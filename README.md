# DealDecoder: Automated Discount Engine
...
1. **Frontend**: Vite + React. Client-side handling of CSV parsing and dynamic UI state.
2. **Backend**: FastAPI + Python. Houses the core logic (`engine.py`) and AI orchestration (`llm.py`).
3. **AI Models**: 
...
3. Add the Environment Variable `VITE_API_URL` pointing to your Render backend URL (e.g., `https://your-backend.onrender.com`).
